...
void Interpreter::initializeMappings(ros::NodeHandle& nh) {
	...
	// Categories
	category_map_["object_category"].push_back(std::make_pair("drink", 3));
	category_map_["object_category"].push_back(std::make_pair("bathroomstuff", 1));
	category_map_["location_category"].push_back(std::make_pair("seat", 2));
	category_map_["location_category"].push_back(std::make_pair("table", 2));
	category_map_["location_category"].push_back(std::make_pair("shelf", 3));
	category_map_["location_category"].push_back(std::make_pair("bin", 1));

    category_map_["room_category"].push_back(std::make_pair("room", 2));
    category_map_["room_location_category"].push_back(std::make_pair("bedroom", 4));
    category_map_["room_location_category"].push_back(std::make_pair("livingroom", 4));
